...
🔹 **Текущая работа:** Разработчик/Инженер AI
...
## 🌟 Мои проекты
- **[Система рекомендаций товаров на основе LightGBM](https://github.com/akayooo/LightGBM-Recommender)** — Проект для рекомендаций товаров с использованием алгоритма LightGBM.
- **[FAISS API для обработки текста](https://github.com/akayooo/FAISS-Text-Processing-API)** — Разработка API для обработки текста с помощью FAISS и генеративных моделей.
- **[AutoML Pipeline для бинарной классификации](https://github.com/akayooo/AutoML-Pipeline)** — Автоматизированный pipeline для бинарной классификации с использованием AutoGluon и LightAutoML.
